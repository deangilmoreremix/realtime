...
const models = [
  { id: 'leonardo-creative-sdxl', name: 'Creative SDXL' },
  { id: 'leonardo-creative-v2', name: 'Creative V2' },
  { id: 'leonardo-creative-v1', name: 'Creative V1' },
  { id: 'leonardo-diffusion-v2', name: 'Diffusion V2' },
  { id: 'leonardo-diffusion-v1', name: 'Diffusion V1' }
];
...
const generationModes = [
  ...
  { id: 'outpainting', name: 'Outpainting' }
];
